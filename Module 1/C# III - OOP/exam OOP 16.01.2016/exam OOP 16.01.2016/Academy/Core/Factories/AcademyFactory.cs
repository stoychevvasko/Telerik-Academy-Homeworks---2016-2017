...
namespace Academy.Core.Factories
{
    public class AcademyFactory : IAcademyFactory
    {
        ...
        public ILectureResouce CreateLectureResouce(string type, string name, string url)
        {
            ...
            switch (type)
            {
                case "video": return new VideoResource(name, url) as LectureResource;
                case "presentation": return new PresentationResource(name, url) as LectureResource;
                case "demo": return new DemoResource(name, url) as LectureResource;
                case "homework": return new HomeworkResource(name, url) as LectureResource;
